...
OBJS=vcodec_omx.o htsp.o vo_pi.o codec.o audioplay.o acodec_mpeg.o acodec_aac.o acodec_a52.o channels.o events.o avahi.o osd.o tiresias_pcfont.o avl.o omx_utils.o
...
pidvbip: pidvbip.c libs/vgfont/libvgfont.a libs/ilclient/libilclient.a $(OBJS)
	$(CC) $(INCLUDES) $(CFLAGS) $(LDFLAGS) -o pidvbip pidvbip.c $(OBJS) libs/ilclient/libilclient.a libs/vgfont/libvgfont.a $(LIBS)
