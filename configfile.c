...
cmdline_opt_t cmdline_opts[] = {
  ...
  {   0, "startup-stopped",   "Do not stream a channel on startup",      OPT_BOOL, &global_settings.startup_stopped, 0, NULL },
  ...
  {   0, "max-stream-time",   "Maximum stream time (in seconds)",         OPT_BOOL, &global_settings.max_stream_time, 0, NULL },
